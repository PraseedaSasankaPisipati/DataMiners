...
What is the trend of all the five-leading cause of deaths over time for each year?

What is the maximum and minimum number of expected deaths, observed deaths, potentially excess deaths for a particular cause of death in each age group?

What is the trend of the deaths over various regions of US? Which region has the maximum and minimum number of deaths?

What is the trend of expected deaths, observed deaths, potentially excess deaths in each region for each benchmark in each locality?

What is the ratio between the observed deaths and the Population?

What is the trend of the ratios over time by region?

What is the ratio between the expected deaths and the Population?
What is the trend of the ratios over time by region?
