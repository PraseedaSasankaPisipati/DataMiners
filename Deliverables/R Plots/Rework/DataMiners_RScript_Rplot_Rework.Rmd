...
ggplot(Obs.Deaths_region,aes(x = region,y = percent_obs.deaths/20000000000000000,fill = region)) + labs(title="Trend of Observed Deaths percentage", x="Region",y="Observed Deaths/Population") + geom_bar(stat = "identity")
```
...
```{r exp.Deaths_region, Obs.Deaths_region, echo=FALSE}
...
But the ratios recorded a non-corrleation i.e one ratio increased and the other ratio decreased in 6% of the cases. 
